...
Console.WriteLine(ints.Any(i => i > 5)); // True
Console.WriteLine(st1.Any(c => c == 'z')); // False
...
Console.WriteLine(ints.Contains(2)); // True
Console.WriteLine(st1.Contains('f')); // False